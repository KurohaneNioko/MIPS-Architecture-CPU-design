...
#endif
static const char *ng0 = "F:/ProgrammingProjects/VerilogHDL/P7-MIPSMicroSYS/ControlUnit_D.v";
...
LAB125:    if (*((unsigned int *)t1006) != 0)
        goto LAB126;

LAB127:    t1013 = (t4 + 4);
    t1014 = *((unsigned int *)t4);
    t1015 = *((unsigned int *)t1013);
    t1016 = (t1014 || t1015);
    if (t1016 > 0)
        goto LAB128;

LAB129:    t1018 = *((unsigned int *)t4);
    t1019 = (~(t1018));
...
LAB131:    if (*((unsigned int *)t1013) > 0)
        goto LAB132;

LAB133:    if (*((unsigned int *)t4) > 0)
        goto LAB134;

LAB135:    memcpy(t3, t1022, 8);

LAB136:    t1023 = (t0 + 2208);
    t1024 = (t1023 + 32U);
    t1025 = *((char **)t1024);
    t1026 = (t1025 + 40U);
    t1027 = *((char **)t1026);
    ...
    t1029 = t1028;
    t1030 = (t3 + 4);
    t1031 = *((unsigned int *)t3);
    t1028 = (t1028 & t1031);
    t1032 = *((unsigned int *)t1030);
    t1029 = (t1029 & t1032);
    t1033 = (t1027 + 4);
    t1034 = *((unsigned int *)t1027);
    *((unsigned int *)t1027) = (t1034 | t1028);
    t1035 = *((unsigned int *)t1033);
    *((unsigned int *)t1033) = (t1035 | t1029);
    xsi_driver_vfirst_trans(t1023, 0, 0);
    t1036 = (t0 + 2120);
    *((int *)t1036) = 1;
...
LAB121:    t990 = *((unsigned int *)t978);
    ...
    *((unsigned int *)t978) = (t990 | t991);
    ...
    t995 = (~(t994));
    t996 = *((unsigned int *)t932);
    t997 = (t996 & t995);
    t998 = *((unsigned int *)t993);
    t999 = (~(t998));
    t1000 = *((unsigned int *)t962);
    t1001 = (t1000 & t999);
    t1002 = (~(t997));
    t1003 = (~(t1001));
...
LAB128:    t1017 = ((char*)((ng12)));
    goto LAB129;

LAB130:    t1022 = ((char*)((ng13)));
    goto LAB131;

LAB132:    xsi_vlog_unsigned_bit_combine(t3, 32, t1017, 32, t1022, 32);
    goto LAB136;

LAB134:    memcpy(t3, t1017, 8);
    goto LAB136;
...
LAB113:    t747 = ((char*)((ng25)));
    goto LAB114;

LAB115:    t752 = ((char*)((ng13)));
    goto LAB116;
...
extern void work_m_00000000003517688272_1478518036_init()
{
	...
	xsi_register_didat("work_m_00000000003517688272_1478518036", "isim/NormalDatapath_isim_beh.exe.sim/work/m_00000000003517688272_1478518036.didat");
