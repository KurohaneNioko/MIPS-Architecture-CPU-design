...
#endif
static const char *ng0 = "F:/ProgrammingProjects/VerilogHDL/P7-MIPSMicroSYS/NPC.v";
...
LAB44:    if (*((unsigned int *)t168) > 0)
        goto LAB45;

LAB46:    memcpy(t167, t215, 8);

LAB47:    goto LAB26;

LAB27:    xsi_vlog_unsigned_bit_combine(t3, 32, t162, 32, t167, 32);
    goto LAB31;
...
LAB62:    memcpy(t215, t263, 8);

LAB63:    goto LAB42;

LAB43:    xsi_vlog_unsigned_bit_combine(t167, 32, t210, 32, t215, 32);
    goto LAB47;

LAB45:    memcpy(t167, t210, 8);
    goto LAB47;
...
LAB71:    if (*((unsigned int *)t272) > 0)
        goto LAB72;

LAB73:    if (*((unsigned int *)t264) > 0)
        goto LAB74;

LAB75:    memcpy(t263, t281, 8);

LAB76:    goto LAB58;

LAB59:    xsi_vlog_unsigned_bit_combine(t215, 32, t258, 32, t263, 32);
    goto LAB63;

LAB61:    memcpy(t215, t258, 8);
    goto LAB63;

LAB64:    *((unsigned int *)t264) = 1;
    goto LAB67;
...
LAB68:    t276 = ((char*)((ng12)));
    goto LAB69;

LAB70:    t281 = ((char*)((ng13)));
    goto LAB71;

LAB72:    xsi_vlog_unsigned_bit_combine(t263, 32, t276, 32, t281, 32);
    goto LAB76;

LAB74:    memcpy(t263, t276, 8);
    goto LAB76;
...
LAB46:    t126 = (t0 + 1208U);
    ...
    *((unsigned int *)t132) = t141;
    ...
    xsi_vlogtype_concat(t128, 32, 32, 3U, t131, 14, t130, 16, t126, 2);
    memset(t142, 0, 8);
    xsi_vlog_unsigned_add(t142, 32, t127, 32, t128, 32);
    goto LAB47;
...
LAB70:    memcpy(t147, t184, 8);

LAB71:    goto LAB49;

LAB50:    xsi_vlog_unsigned_bit_combine(t96, 32, t142, 32, t147, 32);
    goto LAB54;

LAB52:    memcpy(t96, t142, 8);
    goto LAB54;
...
LAB67:    xsi_vlog_unsigned_bit_combine(t147, 32, t179, 32, t184, 32);
    goto LAB71;

LAB69:    memcpy(t147, t179, 8);
    goto LAB71;

}


extern void work_m_00000000003014707308_0757879789_init()
{
	static char *pe[] = {(void *)Cont_34_0,(void *)Cont_35_1,(void *)Cont_39_2,(void *)Cont_40_3,(void *)Cont_41_4,(void *)Cont_42_5,(void *)Cont_43_6,(void *)Cont_44_7,(void *)Cont_45_8,(void *)Cont_46_9,(void *)Cont_47_10,(void *)Cont_48_11,(void *)Cont_49_12,(void *)Cont_50_13,(void *)Cont_52_14,(void *)Cont_56_15,(void *)Cont_57_16};
	xsi_register_didat("work_m_00000000003014707308_0757879789", "isim/NormalDatapath_isim_beh.exe.sim/work/m_00000000003014707308_0757879789.didat");
